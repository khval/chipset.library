...
/****** chipset/main/bitChgChipWord ******************************************
*
*   NAME
*      bitChgChipWord -- Description
*
*   SYNOPSIS
...
void _chipset_bitChgChipWord(struct chipsetIFace *Self,  char * offset, ULONG bit)
{
	 _bitChgChipWord(offset, bit);
}
