...
/****** chipset/main/bitSetChipByte ******************************************
*
*   NAME
*      bitSetChipByte -- Description
*
*   SYNOPSIS
...
void _chipset_bitSetChipByte(struct chipsetIFace *Self, char * offset, ULONG bit)
{
	_bitSetChipByte(offset, bit);
}
