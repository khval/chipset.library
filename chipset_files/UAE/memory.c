...
uae_u32 chipmem_lget (uaecptr) REGPARAM;
uae_u32 chipmem_wget (uaecptr) REGPARAM;
uae_u32 chipmem_bget (uaecptr) REGPARAM;
void chipmem_lput (uaecptr, uae_u32) REGPARAM;
void chipmem_wput (uaecptr, uae_u32) REGPARAM;
void chipmem_bput (uaecptr, uae_u32) REGPARAM;
int chipmem_check (uaecptr addr, uae_u32 size) REGPARAM;
uae_u8 *chipmem_xlate (uaecptr addr) REGPARAM;
